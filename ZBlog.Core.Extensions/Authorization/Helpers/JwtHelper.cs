...
namespace ZBlog.Core.Extensions.Authorization.Helpers
{
    public class JwtHelper
    {
        ...
        public static string IssueJwt(TokenModelJwt tokenModel)
        {
            ...
            // 可以将一个用户的多个角色全部赋予；
            claims.AddRange(tokenModel.Role.Split(',').Select(it => new Claim(ClaimTypes.Role, it)));
        ...
        public static bool CustomSafeVerify(string token)
        {
            ...
            var result = jwt.RawSignature == Microsoft.IdentityModel.JsonWebTokens.JwtTokenUtilities.CreateEncodedSignature(jwt.RawHeader + "." + jwt.RawPayload, signingCredentials);
