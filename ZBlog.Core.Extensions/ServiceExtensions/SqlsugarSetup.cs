...
using ZBlog.Core.Common.DB.Aop;
...
namespace ZBlog.Core.Extensions.ServiceExtensions
{
    ...
    public static class SqlsugarSetup
    {
        ...
        public static void AddSqlsugarSetup(this IServiceCollection services)
        {
            ...
            BaseDBConfig.MutiConnectionString.allDbs.ForEach(mutiDB =>
            {
                var config = new ConnectionConfig
                {
                    ...
                    // 从库
                    SlaveConnectionConfigs = mutiDB.Slaves?.Where(s => s.HitRate > 0)
                ...
                if (SqlSugarConst.LogConfigId.ToLower().Equals(mutiDB.ConnId.ToLower()))
                {
                ...
                else
                {
                    ...
                    else if (mutiDB.ConnId.ToLower().StartsWith(MainDb.CurrentDbConnId.ToLower()))
                    {
                        //复用连接
