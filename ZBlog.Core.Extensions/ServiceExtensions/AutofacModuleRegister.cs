...
using ZBlog.Core.Extensions.AOP;
...
namespace ZBlog.Core.Extensions.ServiceExtensions
{
    public class AutofacModuleRegister : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "ZBlog.Core.Services.dll");
            var repositoryDllFile = Path.Combine(basePath, "ZBlog.Core.Repository.dll");
            ...
            {
                builder.RegisterType<UserAuditAOP>();
                cacheType.Add(typeof(UserAuditAOP));
            }
            ...
            //var assemblysServicesNoInterfaces = Assembly.Load("ZBlog.Core.Services");
            ...
            //不用虚方法
            //builder.RegisterType<AopService>()
            //   .As<IAopService>()
            //   .AsImplementedInterfaces()
