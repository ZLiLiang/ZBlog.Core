...
namespace ZBlog.Core.Common.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.Api.Controllers", "ZBlog.Core.Api.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.Model", "ZBlog.Core.Model.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.IRepository", "ZBlog.Core.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.IServices", "ZBlog.Core.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.Repository", "ZBlog.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ZBlog.Core.Services", "ZBlog.Core.Services", tableNames, "", isMuti);
            return true;
        }
...
@"{SugarColumn}
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
@"using ZBlog.Core.IRepository.Base;
using ZBlog.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using ZBlog.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using ZBlog.Core.IRepository.UnitOfWork;
using ZBlog.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using ZBlog.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using ZBlog.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
