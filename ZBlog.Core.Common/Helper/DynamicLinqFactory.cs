        ...
        public static Expression ExpressionStudio(Expression left, DynamicLinqHelper dynamicLinq, ParameterExpression key)
        {
            ...
            if (!dynamicLinq.Left.IsNullOrEmpty())
            {
                ...
                foreach (var t in properties)
                {
                    ...
                    {
                        //return ExpressionStudioEnumerable(left, mainExpression, dynamicLinq.Adapt<DynamicLinqHelper>(), properties.Skip(index).ToArray());
                        return ExpressionStudioEnumerable(left, mainExpression, dynamicLinq, properties.Skip(index).ToArray());
                    }
