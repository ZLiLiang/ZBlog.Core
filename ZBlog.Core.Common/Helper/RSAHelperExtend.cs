...
namespace ZBlog.Core.Common.Helper
{
    ...
    public class RSAHelperExtend
    {
        ...
        public static string RSAPrivateKeyDotNet2Java(string privateKey)
        {
            ...
            document.LoadXml(privateKey);

            BigInteger m = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("Modulus")[0].InnerText));
            BigInteger exp = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("Exponent")[0].InnerText));
            BigInteger d = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("D")[0].InnerText));
            BigInteger p = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("P")[0].InnerText));
            BigInteger q = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("Q")[0].InnerText));
            BigInteger dp = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("DP")[0].InnerText));
            BigInteger dq = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("DQ")[0].InnerText));
            BigInteger qinv = new BigInteger(Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("InverseQ")[0].InnerText));
        ...
        {
            XmlDocument document = new XmlDocument();
            document.LoadXml(publicKey);

            BigInteger m = new BigInteger(1, Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("Modulus")[0].InnerText));
            BigInteger p = new BigInteger(1, Convert.FromBase64String(document.DocumentElement.GetElementsByTagName("Exponent")[0].InnerText));
