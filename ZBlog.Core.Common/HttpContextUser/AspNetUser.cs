...
namespace ZBlog.Core.Common.HttpContextUser
{
    public class AspNetUser : IUser
    {
        ...
        private string GetName()
        {
            ...
            else
            {
                if (!string.IsNullOrEmpty(GetToken()))
                {
                    ...
                    return GetUserInfoFromToken(getNameType)
                        .FirstOrDefault()
                        .ObjToString();
                }
            }
        ...
        public string GetToken()
        {
            ...
            if (_accessor.HttpContext?.IsSuccessSwagger() == true)
            {
                ...
                {
                    if (_accessor.HttpContext
                        .User
                        .Claims
                        .Any(s => s.Type == JwtRegisteredClaimNames.Jti))
                        return token;
