...
namespace ZBlog.Core.Common.Extensions
{
    ...
    public static class EnumExtension
    {
        ...
        public static string EnumDescription(this Enum @enum)
        {
            ...
            //if (!(Attribute.GetCustomAttribute(field, typeof(DescriptionAttribute)) is DescriptionAttribute attribute)) return name;
            if (Attribute.GetCustomAttribute(field, typeof(DescriptionAttribute)) is not DescriptionAttribute attribute) return name;

            return attribute?.Description;
        }

        public static int ToEnumInt(this Enum @enum)
        {
            try
            {
