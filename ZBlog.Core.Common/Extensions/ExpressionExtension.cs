...
namespace ZBlog.Core.Common.Extensions
{
    ...
    public static class ExpressionExtension
    {
        ...
        /// <returns></returns>
        public static async Task Cof_SendResponse(this HttpContext context, HttpStatusCode code, string message,
        ...
        /// <returns></returns>
        public static T Cof_GetICaching<T>(this ICaching cache, string key, Func<T> GetFun, int timeSpanMin)
            where T : class
        {
        ...
        /// <param name="timeSpanMin">有效期 单位分钟</param>
        /// <returns></returns>
		public static async Task<T> Cof_AsyncGetICaching<T>(this ICaching cache, string key, Func<Task<T>> GetFun, int timeSpanMin)
            where T : class
        {
