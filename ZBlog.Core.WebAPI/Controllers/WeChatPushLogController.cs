...
namespace ZBlog.Core.WebAPI.Controllers
{
    ...
    public class WeChatPushLogController : ControllerBase
    {
        private readonly IWeChatPushLogService _weChatPushLogService;

        public WeChatPushLogController(IWeChatPushLogService weChatPushLogService)
        {
            _weChatPushLogService = weChatPushLogService;
        }
        ...
        {
            var data = await _weChatPushLogService.QueryPage(pagination);
            return new MessageModel<PageModel<WeChatPushLog>>
            {
                Success = true,
                Response = data
            };
        ...
        {
            var data = await _weChatPushLogService.QueryById(id);
            return new MessageModel<WeChatPushLog>
            {
                Success = true,
                Response = data
            };
        ...
        {
            await _weChatPushLogService.Add(obj);
        ...
        {
            await _weChatPushLogService.Update(obj);
            return new MessageModel<string> { Success = true };
        }
        ...
        {
            await _weChatPushLogService.DeleteById(id);
            return new MessageModel<string> { Success = true };
        }
        ...
        {
            var i = ids.Split(",");
            await _weChatPushLogService.DeleteByIds(i);
            return new MessageModel<string> { Success = true };
        }
    }
}
